/*! TenVideoPlayer_V2 - v2.0.0 - 2017-09-22 10:24:44
 * Copyright (c) 2017
...
! function (a) {
    if (function (a) {
        ...
        }(jQuery), tvp = {}, tvp.lastModify = "2017-09-22 10:24:44", tvp.ts = tvp.lastModify.replace(/\D/g, ""), tvp.ver = "$V2.0Build9432$", tvp.dataset = {
            openLazy: !0
    ...
    var c = !1;
    "undefined" != typeof Zepto && Zepto._tvp ? (tvp.$ = Zepto, c = !0) : (tvp.$ = {}, c = !1),
        function () {
            ...
            var b = {
                ...
                formatTpl: function (b, c) {
                    if (b && "object" === a.type(c)) {
                        for (var d in c)
                            for (var e = "${" + d + "}"; b.indexOf(e) > -1;) b = b.replace(e, c[d]);
                        return b
                    }
                },
                loadCss: function (b) {
            ...
            bindNewMethodOnOpenAppInWeixin: function (a) {
                if (a && a.attr && a.on && a.removeAttr && tvp.common.isNewWX("6.5.6")) {
                    var b = function (a) {
                        ...
                        c = a.attr("href");
                    (b(c) || (c = a.attr("data-url"), b(c))) && (a && 1 == a.length ? a.attr({
                        "data-schemeUrl": c
                ...
                getOcx: function (b) {
                    ...
                    if (tvp.$.browser.ie) try {
                        ...
                        if (k)
                            ...
                            } else f = "plug.version:" + k.version, d = k.version;
        ...
        function (a, b) {
            ...
            k.cgi = function () {
                ...
                loadVideoUrlByVid_base: function (d, f) {
                    ...
                    }, b.browser.WeChat && (b.os.ipad ? r.device = "60101" : b.os.iphone ? r.device = "60401" : b.os.android && !b.os.tablet ? r.device = "60301" : b.os.android && b.os.tablet && (r.device = "60501")), n.commonAuthData && (n.commonAuthData.auth_from || n.commonAuthData.auth_ext) && (n.commonAuthData.auth_from && (r.auth_from = n.commonAuthData.auth_from), n.commonAuthData.auth_ext && (r.auth_ext = n.commonAuthData.auth_ext)), d.retryDefer && b.isFunction(d.retryDefer.reject) && (t = !0, q = d.retryDefer, u = k.retryCgi.getinfo, z = k.retryCgi.getkey), d.loadingAdCgi && (u = d.loadingAdCgi, d.noAuth = !0), d.defer && (q = d.defer), y = i({
                        itype: 1,
                        val2: t ? 1 : 0,
                        str3: x,
                        vid: n.vid,
                    ...
                    var A = function (e) {
                        ...
                        B = function (f) {
                            var h, k = l.ul.ui[0];
                            o.br = l.br, o.path = k.url, o.fn = l.fn, o.fiid = e(n, f.fl.fi), o.vt = k.vt, h = new a.RetCode(100127), h.begin(), v = b.now();
                        ...
                        C = function () {
                            ...
                            r._rnd = c, x = u + b.param(r), f && "object" === b.type(f) && (x += "&" + b.param(f)), x = j(x, c), b.ajax({
                                ...
                                if (!d.noAuth && c && 0 != c.em && "o" != c.s) {
                                    ...
                                    if (83 === c.em && r.eduext);
                                    else if (!(b.inArray(c.em, [100]) > -1)) return d.noAuth = !0, d.defer = q, void a.h5Helper.loadVideoUrlByVid(d)
                                }
                                A(c)
                            }).fail(function () {
                                if (s.reportErr(), y({
                ...
                loadHLSUrlByVid: function (c) {
                    ...
                    return g = j(g), h(), f.begin(), b.ajax({
                        ...
                        for (var d = [], g = -2, i = 0; i < c.vd.vi.length; i++)
                            if (g = c.vd.vi[i].ch, 2 == c.vd.vi[i].st) {
            ...
            if (!window.txvLogin) {
                ...
                a.prototype = {
                    ...
                    getUserInfo: function () {
                        ...
                        "function" != typeof b && (b = function () {}), this.isLogin(function (d, f) {
                    ...
                    tvSwitchLogin: function (a, b) {
                        b = b || function () {}, e.isipad ? b(new Error("iPad not support SwitchLogin")) : this.tenvideoJSReady(function () {
